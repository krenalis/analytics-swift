...
E2E test CLI for the [analytics-swift](https://github.com/krenalis/analytics-swift) SDK. Accepts a JSON input describing events and SDK configuration, sends them through the real SDK, and outputs results as JSON.
