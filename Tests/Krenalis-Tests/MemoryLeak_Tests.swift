...
final class MemoryLeak_Tests: XCTestCase {
    ...
    func testLeaksVerbose() throws {
        ...
        let destMetadata = krenalisDest.timeline.find(pluginType: DestinationMetadataPlugin.self)!
        ...
        analytics.remove(plugin: krenalisDest)
        krenalisDest.remove(plugin: destMetadata)
