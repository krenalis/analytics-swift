...
class DirectoryStore_Hardening_Tests: XCTestCase {
    ...
    override func setUpWithError() throws {
        storageURL = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("krenalis-hardening-tests")
    ...
    override func tearDownWithError() throws {
        ...
        UserDefaults(suiteName: "com.krenalis.storage.hardening-test")?
            .removePersistentDomain(forName: "com.krenalis.storage.hardening-test")
    }
    ...
    func testCrashRecoverySkipsFinalizedFile() throws {
        ...
        let finalizedFileURL = storageURL.appendingPathComponent("0-krenalis-events")
    ...
    func testCrashRecoveryResumesUnfinishedFile() throws {
        ...
        let partialFileURL = storageURL.appendingPathComponent("0-krenalis-events")
