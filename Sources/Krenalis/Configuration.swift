...
public protocol AnonymousIdGenerator: AnyObject, Codable {
    /// Returns a new anonymousId.  Krenalis still manages storage and retrieval of the
...
public enum OperatingMode {
    ...
    static internal let defaultQueue = DispatchQueue(
        label: "com.krenalis.operatingModeQueue", qos: .utility)
}
...
public class Configuration {
    internal struct Values {
        ...
        var autoAddKrenalisDestination: Bool = true
        ...
        var anonymousIdGenerator: AnonymousIdGenerator = KrenalisAnonymousId()
    ...
    ///
    /// - Parameter writeKey: Your Krenalis write key value
    public init(writeKey: String) {
        ...
        // enable krenalis destination by default
...
extension Configuration {
    ...
    /// Example:
    /// ```
    /// let defaults = Settings.load(resource: "myKrenalisSettings.json")
    ...
    /// Enable/Disable the automatic adding of Krenalis as a destination.
    ...
    /// - Returns: The current Configuration.
    @discardableResult
    public func autoAddKrenalisDestination(_ value: Bool) -> Configuration {
        values.autoAddKrenalisDestination = value
        return self
    }

    /// Enable/Disable the automatic adding of Krenalis as a destination.
    /// Same as `autoAddKrenalisDestination`. This remains for compatibility
    ...
    /// Sets an error handler to be called when errors are encountered by the Krenalis
    ...
    /// value is a Krenalis owned background queue.
    @discardableResult
    ...
    /// Specify a custom anonymousId generator.  The default is and instance of `KrenalisAnonymousId`.
    @discardableResult
