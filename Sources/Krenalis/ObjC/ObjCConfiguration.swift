...
public class ObjCConfiguration: NSObject {
    ...
    @objc
    public var autoAddKrenalisDestination: Bool {
        get {
            return configuration.values.autoAddKrenalisDestination
        }
        set(value) {
            configuration.autoAddKrenalisDestination(value)
        }
    }
