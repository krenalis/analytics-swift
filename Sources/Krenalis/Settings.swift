...
public struct Settings: Codable {
    ...
    public init(writeKey: String, endpoint: String) {
        integrations = try! JSON([
            KrenalisDestination.Constants.integrationName.rawValue: [
                KrenalisDestination.Constants.apiKey.rawValue: writeKey,
                KrenalisDestination.Constants.endpoint.rawValue: endpoint
            ]
        ])
    }
    ...
    public init(writeKey: String) {
        integrations = try! JSON([
            KrenalisDestination.Constants.integrationName.rawValue: [
                KrenalisDestination.Constants.apiKey.rawValue: writeKey,
                KrenalisDestination.Constants.endpoint.rawValue: HTTPClient.getDefaultEndpoint()
            ]
        ])
    }
