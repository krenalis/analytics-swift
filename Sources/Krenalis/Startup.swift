...
extension Analytics: Subscriber {
    ...
    internal func platformStartup() {
        ...
        // add krenalis destination plugin unless
        // asked not to via configuration.
        if configuration.values.autoAddKrenalisDestination && configuration.values.autoAddSegmentDestination {
            let krenalisDestination = KrenalisDestination()
            krenalisDestination.analytics = self
            add(plugin: krenalisDestination)
        }
